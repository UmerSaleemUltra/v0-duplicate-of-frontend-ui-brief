    ...
    <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 pb-6 md:pb-10">
      ...
      <div className="flex flex-col-reverse sm:flex-row gap-3 pt-6">
        <Button
          ...
          className="w-full sm:w-auto px-6 sm:px-8 h-12 text-base font-semibold border-slate-300 hover:bg-slate-50 bg-white text-slate-900 sm:min-w-[180px]"
        >
        ...
        <Button
          ...
          className="w-full sm:flex-1 h-12 px-6 sm:px-10 text-base bg-gradient-to-r from-[#880000] to-[#ff0d13] hover:from-[#990000] hover:to-[#ff1a1a] text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
            <>
