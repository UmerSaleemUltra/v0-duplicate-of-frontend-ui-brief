...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #f5f5f5;">
  ...
  companyApplicationApplied: (name: string, companyName: string) => ({
    subject: "Your Company Application Has Been Submitted",
    html: `
    <!DOCTYPE html>
    <html>
      <head>
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px;">
                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px;">
                    ...
                    <p style="margin: 0 0 20px 0; font-size: 14px; color: #333333; line-height: 1.6;">
                      Your company formation application for <strong>${companyName}</strong> has been successfully submitted to the State. 
                    </p>
                    
                    <p style="margin: 0 0 20px 0; font-size: 14px; color: #333333; line-height: 1.6;">
                      We are now monitoring the approval process and will keep you updated every step of the way. Processing typically takes between 5-15 business days, depending on your state.
                    </p>
                    ...
                    <ul style="margin: 0 0 20px 0; padding-left: 20px;">
                      <li style="margin: 0 0 8px 0; font-size: 14px; color: #333333; line-height: 1.6;">The State will review your application</li>
                      <li style="margin: 0 0 8px 0; font-size: 14px; color: #333333; line-height: 1.6;">You'll receive updates in real-time on your dashboard</li>
                      <li style="margin: 0; font-size: 14px; color: #333333; line-height: 1.6;">Once approved, we'll move forward with the next steps</li>
                    </ul>
                    
                    <p style="margin: 0 0 20px 0; font-size: 14px; color: #333333; line-height: 1.6;">
                      You can track the progress in your Buzz Filing Dashboard. If you have any questions or concerns, simply reply to this email or contact our support team.
                    </p>
