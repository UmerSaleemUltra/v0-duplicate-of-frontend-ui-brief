...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // Note: Manual data updates (registered agent, business address, tax data) 
    // do not send emails directly. Emails are only sent when milestones are 
    // explicitly updated via the milestones API endpoint.
