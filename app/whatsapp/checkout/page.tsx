...
export default function Page() {
  ...
  const onSubmit = async (ev: React.FormEvent) => {
    ...
    setSubmitting(true);
    // Single submission payload
    const payload = {
      account: { fullName, phone, email, password, terms },
      formation: { state: formationState, entity: entityType, package: pkg, priceUSD },
      business: { businessName, website, category, description },
      members,
      payment: { method: paymentMethod, whatsapp, receiptFileName },
    };
    // eslint-disable-next-line no-console
    console.log("LLC formation submission:", payload);
