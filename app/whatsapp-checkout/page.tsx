...
{submitting && (
  <div
    className="fixed inset-0 z-[100] flex min-h-dvh items-center justify-center bg-white/80 px-4 py-6 backdrop-blur-sm sm:px-6"
    role="dialog"
    aria-modal="true"
    aria-labelledby="checkout-loading-title"
    aria-describedby="checkout-loading-description"
  >
    <div className="w-full max-w-md overflow-hidden rounded-3xl border border-[#ff0d13]/15 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.16)]">
      <div className="h-1.5 w-full overflow-hidden bg-[#ff0d13]/10">
        <div className="h-full w-1/3 animate-[loading-slide_1.4s_ease-in-out_infinite] rounded-full bg-[#ff0d13]" />
      </div>
      <div className="px-6 py-8 text-center sm:px-10 sm:py-10">
        <div className="relative mx-auto mb-6 grid h-20 w-20 place-items-center rounded-full border-8 border-[#ff0d13]/10 bg-[#ff0d13]/5">
          <div className="absolute inset-[-8px] animate-spin rounded-full border-4 border-transparent border-t-[#ff0d13]" />
          <Sparkles className="h-8 w-8 text-[#ff0d13]" aria-hidden="true" />
        </div>
        <p id="checkout-loading-title" className="text-xl font-extrabold tracking-tight text-slate-900 sm:text-2xl">
          Creating your BuzzFiling order
        </p>
        <p id="checkout-loading-description" className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-500">
          We&apos;re securely saving your details. Please keep this page open<span className="inline-flex w-8 text-left"><span className="animate-pulse">...</span></span>
        </p>
        <div className="mt-7 flex items-center justify-center gap-2 text-xs font-bold text-slate-500">
