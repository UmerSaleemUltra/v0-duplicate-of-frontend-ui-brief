...
import { Landmark, Search, Filter, CheckCircle2, Clock, XCircle, Eye } from "lucide-react"
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search by name, business, email, or bank..."
                value={searchTerm}
            ...
            <div className="space-y-6 mt-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-slate-900 font-medium">{selectedApplication.bank_name}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-slate-900 font-medium capitalize">{selectedApplication.funding_source}</p>
                </div>
                <div>
