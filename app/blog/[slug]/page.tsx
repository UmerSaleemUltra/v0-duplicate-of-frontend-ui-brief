    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-background pt-16 sm:pt-18 md:pt-20">
        <article className="mx-auto max-w-4xl px-4 py-4 sm:px-6 sm:py-6 md:px-8 md:py-8">
          ...
          {post.category && (
            <div className="mb-4">
              <span className="inline-block rounded-full bg-[#8B1538] px-3 py-1 text-xs font-semibold text-white sm:px-4 sm:py-1.5 sm:text-sm">
                {post.category}
              </span>
            </div>
          )}
          ...
          <div
            className="prose prose-sm max-w-none
              ...
              prose-a:text-[#8B1538] prose-a:font-medium prose-a:no-underline hover:prose-a:underline
              prose-strong:text-foreground prose-strong:font-semibold
              prose-ul:pl-5 prose-ol:pl-5
              prose-li:text-foreground prose-li:marker:text-[#8B1538] prose-li:my-1
              prose-li:text-sm md:prose-li:text-base lg:prose-li:text-lg
              prose-blockquote:border-l-4 prose-blockquote:border-[#8B1538] prose-blockquote:pl-4
          ...
          <div className="mt-8 border-t border-border pt-6 md:mt-10 md:pt-8">
            <Link
              href="/blog"
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#8B1538] px-5 py-3 text-sm font-medium text-white transition-all hover:bg-[#6D0F2C] sm:w-auto sm:text-base"
            >
